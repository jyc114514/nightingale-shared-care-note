...
| 51 | RBAC implementation constraints | Role-specific browser projections matched the server response. Clinician editing was limited to the Clinician plan; Staff editing was limited to the Staff note. | Online smoke plus local authorization tests |
