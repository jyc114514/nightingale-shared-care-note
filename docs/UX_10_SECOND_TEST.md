...
5. After the timer, ask the participant to open the source, explain “derived summary · not canonical
   source,” and say whether the selected source remains visible after the focus ring fades.
