...
try {
  ...
  $secondOutput = powershell.exe -NoProfile -ExecutionPolicy Bypass -File $startScript -NoBrowser -ProviderOverride fixture -TimeoutSeconds 10 -RuntimeDirectory $runtimeRoot 2>&1 | Out-String
